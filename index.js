    ...
    if (!meddelande.author.bot) {
        ...
        if (dravel.startsWith('roll')) {
            ...
            if (meddelande.channel.id == "539847809004994560") {
                ...
                meddelande.reply('I would like to inform and remind you the technological littering is still littering, and by indulging in such vile activities you are tarnishing the sanctity of the channel. Please always make sure to post non-essential bot commands in' + meddelande.guild.channels.cache.get('539847809004994560').toString() + '. Try to think about your actions and how they affect those around you. Warning other player is a good example of an essential bot command.')
            }
            ...
            if (meddelande.member.voice.channel !== null) {
                ...
                const resource = createAudioResource('clickclackmotherfuckerthegunscomingoutyougottreesecondsFIVE.wav');
